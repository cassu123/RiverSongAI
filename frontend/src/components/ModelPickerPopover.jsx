      ...
      <div className="rs-mpop" style={panelStyle}>
        ...
        {pickerView === 'cloudModels' && <>
          ...
          {activeGroup?.availableCount === 0 && (
            <div className="rs-type-micro" style={{ padding: 'var(--rs-space-3) var(--rs-space-4)', margin: 'var(--rs-space-1) var(--rs-space-2) var(--rs-space-3)', borderRadius: 'var(--md-shape-sm)', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: 'var(--md-outline)' }}>
