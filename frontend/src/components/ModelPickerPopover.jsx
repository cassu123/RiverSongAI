      ...
      <div className="rs-mpop" style={panelStyle}>
        ...
        {pickerView === 'cloudModels' && <>
          ...
          {activeGroup?.availableCount === 0 && (
            <div className="rs-type-micro" style={{ padding: '10px 14px', margin: '4px 8px 10px', borderRadius: 8, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: 'var(--md-outline)' }}>
