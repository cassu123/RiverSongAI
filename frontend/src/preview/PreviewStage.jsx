...
import PreviewGrade from './PreviewGrade.jsx'

/**
 * PreviewStage — fixed full-viewport backdrop, swaps by environment.
 *
 ...
 * Canvas 2D particle field tuned to that world. The goal is *transport* —
 * you feel you're in that world, not looking at a tinted poster.
 *
 ...
 *
 * See PREVIEW_IMAGE_PROMPTS.md for the generation prompts.
 */
export default function PreviewStage({ environment }) {
...
/* ─────────────────────────────────────────────────────────────────────────
   useCanvasEffect — shared boilerplate for every scene's particle field.
   Caller provides an init(ctx, w, h) that returns a step() function.
   Handles resize, devicePixelRatio cap (1.5 for S24 Ultra), RAF, cleanup.
   ───────────────────────────────────────────────────────────────────────── */
function useCanvasEffect(canvasRef, init) {
  useEffect(() => {
