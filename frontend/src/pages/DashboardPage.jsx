...
function NimTelemetry({ token }) {
  ...
  return (
    <div>
      ...
      <div className="rs-card-value">{rpm !== null ? rpm : '—'}<small style={{ fontSize: 'var(--rs-fs-nano)', opacity: 0.5, marginLeft: 4 }}>RPM</small></div>
            ...
            <div className="rs-telemetry-container">
              ...
              <div className="rs-telemetry-grid">
                ...
                <div>
                  ...
                  <div className="rs-card-value">12<small style={{ fontSize: 'var(--rs-fs-nano)', opacity: 0.5, marginLeft: 4 }}>MS</small></div>
                  <div className="rs-card-meta">Link speed</div>
                </div>
                <div>
                  <div className="rs-card-label">SECTOR SYNC</div>
                  <div className="rs-card-value">1.2<small style={{ fontSize: 'var(--rs-fs-nano)', opacity: 0.5, marginLeft: 4 }}>GB/S</small></div>
