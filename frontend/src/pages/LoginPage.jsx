...
export default function LoginPage({ onSwitchToSignup }) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const url = `${data.auth_url}&redirect_uri=${encodeURIComponent(redirectUri)}`
  ...
  return (
    <div className="auth-shell">
      <div className="auth-card">
        ...
        <p className="auth-tagline">Personal AI Assistant</p>
        ...
        <button className="auth-btn auth-btn--google" onClick={handleGoogleSignIn} disabled={googleLoading} type="button">
