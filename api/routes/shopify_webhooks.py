...
async def shopify_order_webhook(
    ...
    # Fix: use data/commerce.db (the actual SQLAlchemy DB) instead of commercial_inventory.db
    wrapper = ShopifySyncWrapper(db_path="data/commerce.db", workspace_id="default", user_id="system")
