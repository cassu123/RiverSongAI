...
class MemoryManager:
    ...
    async def build_context_block(self, user_id: str) -> str:
        """
    ...
    async def upsert_fact(
        ...
        logger.debug("Fact upserted (user=%s, key=%s).", user_id, key)
    ...
    async def upsert_preference(
        ...
        logger.debug("Preference upserted (user=%s, category=%s).", user_id, category)
