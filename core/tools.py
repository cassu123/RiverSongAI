...
async def execute_tool(
    ...
    """
        Dispatch a tool request while enforcing administrative security policy.
        
        Args:
            tool_name: Name of the requested tool.
            tool_input: Arguments supplied to the tool.
            context: Execution metadata, including the user ID, store, and tool policy.
        
        Returns:
            A user-facing success, failure, disabled-tool, or unknown-tool message.
        """
